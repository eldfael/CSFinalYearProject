...
public class WeaponLongsword : MonoBehaviour, Weapon
{
    float attackTimer;
    ...
    int damage = 6;
    int staminaCost = 3;
    Vector2 hitbox = new Vector2(2f, 3f);
    ...
    public void OnAttack()
    {
        ...
        projectileController.Create(
            ...
            damage + (playerObject.GetComponent<PlayerController>().GetAGI() / 2 ) + ( playerObject.GetComponent<PlayerController>().GetSTR() / 2), // Damage
